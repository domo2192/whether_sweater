...
RSpec.describe 'Weather Facade' do
  describe 'unit tests' do
    ...
    it 'daily object returns a daily object' do
      ...
      expect(WeatherFacade.daily_object(daily_params)[:sunrise]).to eq("2021-04-24 12:08:57 +0000")
      expect(WeatherFacade.daily_object(daily_params)[:sunset]).to eq("2021-04-25 01:46:43 +0000")
    ...
    it "current forcast returns a object with correct attributes" do
      ...
      expect(WeatherFacade.objectify_current_forecast(current_params)[:datetime]).to eq("2021-04-24 20:52:47 +0000")
      expect(WeatherFacade.objectify_current_forecast(current_params)[:sunrise]).to eq("2021-04-24 12:08:57 +0000")
      expect(WeatherFacade.objectify_current_forecast(current_params)[:sunset]).to eq("2021-04-25 01:46:43 +0000")
